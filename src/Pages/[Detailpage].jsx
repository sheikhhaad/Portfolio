...
import {
  ArrowLeft, ExternalLink, Code, Layout,
  Zap, Globe, Github, ChevronRight,
} from "lucide-react";
...
const TechBadge = ({ tech, index }) => (
  ...
  >
    <span
      ...
      style={{ background: "radial-gradient(circle at 50% 50%, rgba(0,255,0,0.12) 0%, transparent 70%)" }}
    />
...
const work = [
  {
    id: 3, name: "Donation Web", overview: "Online donation platform with real-time tracking.",
    description: "This project was built for handling donations using Firebase Auth and Firestore. Donors can donate in real-time, and features like donor summaries and progress bars are included.",
    features: ["Login with Firebase Auth", "Real-time donations", "Donor summary", "Dynamic progress bar", "Responsive design", "Animations"],
    techStack: ["Next.js", "Firebase", "Tailwind CSS", "Framer Motion"],
    link: "https://lifthumanity.vercel.app/", image: donation, codeLink: "https://github.com/sheikhhaad/donation-user-web", year: "2024", category: "Full-Stack",
  },
  {
    id: 4, name: "Gemini Chatbot AI", overview: "AI chatbot UI inspired by Gemini.",
    description: "This project is a front-end clone of the Gemini chatbot. It provides a chat interface where users can type messages, and includes a typing animation effect for a real-time feel.",
    features: ["Chat interface", "Styled input/output", "Responsive layout", "Real-time typing effect"],
    techStack: ["React", "Tailwind CSS", "Framer Motion", "API Integration"],
    link: "https://chat-bot-gemini-sepia.vercel.app/", image: gemini, codeLink: "https://github.com/sheikhhaad/ChatBot-Gemini", year: "2024", category: "AI / Frontend",
  },
  {
    id: 5, name: "Chat App", overview: "Real-time messaging app with Firebase backend.",
    description: "The Chat App is a complete messaging platform supporting one-to-one and group chats. It uses Firebase Auth and Firestore for real-time messaging and media sharing.",
    features: ["One-to-one chat", "Group chat support", "Read receipts", "Typing indicators", "Media sharing", "Responsive UI"],
    techStack: ["React", "Firebase (Auth, Firestore, Storage)"],
    link: "https://chat-app-rose-theta.vercel.app/", image: chatAppImage, codeLink: "https://github.com/sheikhhaad/Chat-App", year: "2024", category: "Full-Stack",
  },
  {
    id: 6, name: "Blog App", overview: "Platform for creating and sharing blogs.",
    description: "The Blog App is a CMS-style platform where users can create, edit, and delete blogs. It includes Firebase Auth for login, Firestore for real-time storage, and image upload functionality.",
    features: ["User authentication", "CRUD blogs", "Rich text editor", "Image upload", "Responsive design", "Blog detail pages"],
    techStack: ["React", "Firebase (Auth, Firestore, Storage)", "Tailwind CSS"],
    link: "https://blogg-app-tech.vercel.app/", image: blogAppImage, codeLink: "https://github.com/sheikhhaad/Blogg-App-tech", year: "2024", category: "Full-Stack",
  },
  {
    id: 8, name: "Portfolio", overview: "Personal developer portfolio website.",
    description: "This is my personal portfolio website that includes sections for About, Projects, and Contact. It uses Tailwind CSS and Framer Motion for animations and a smooth UI experience.",
    features: ["About section", "Projects showcase", "Contact form", "Animations"],
    techStack: ["React", "Tailwind CSS", "Framer Motion"],
    link: "https://haad-portfolio-haad-sheikhs-projects.vercel.app/", image: portfolioImage, codeLink: "https://github.com/sheikhhaad/Haad", year: "2024", category: "Frontend",
  },
  {
    id: 10, name: "Soni UI", overview: "Automotive brand UI concept.",
    description: "Soni UI is a design concept for an automotive website. It features a product showcase with a gradient-styled UI for a modern look and feel.",
    features: ["Product showcase", "Gradient UI", "Clean layout"],
    techStack: ["React", "Tailwind CSS"],
    link: "https://soni-auto-ui-react.vercel.app/", image: Soni, codeLink: "https://github.com/sheikhhaad/Soni-Auto-UI-react", year: "2024", category: "UI Design",
  },
];
    ...
    return (
      <motion.div className="flex items-center justify-center min-h-screen px-4"
        ...
        <div className="text-center p-8 sm:p-10 rounded-3xl bg-white/5 border border-white/10 w-full max-w-sm">
          <h2 className="text-2xl sm:text-3xl font-black text-white mb-6 font-display">Project not found</h2>
          <Link to="/" className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold bg-accent/20 border border-accent/40 text-white hover:bg-accent/30 transition-all">
    ...
    <>
      ...
      >
        ...
        <div aria-hidden className="pointer-events-none fixed inset-0 overflow-hidden" style={{ zIndex: 0 }}>
          <div style={{ position: "absolute", top: "-80px", left: "-140px", width: "460px", height: "460px", borderRadius: "50%", background: "radial-gradient(circle, rgba(0,255,0,0.08) 0%, transparent 70%)", filter: "blur(90px)" }} />
          <div style={{ position: "absolute", top: "280px", right: "-140px", width: "380px", height: "380px", borderRadius: "50%", background: "radial-gradient(circle, rgba(0,200,80,0.06) 0%, transparent 70%)", filter: "blur(90px)" }} />
        </div>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10 sm:pt-20">
          ...
          <div className="mb-10 sm:mb-12">
            ...
            <Reveal delay={0.1}>
              <h1 className="font-display font-black text-slate-100 tracking-tight mb-3"
                style={{ fontSize: "clamp(1.9rem, 5.5vw, 3.8rem)", lineHeight: 1.07 }}>
                {data.name}
              </h1>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="flex flex-wrap gap-3">
                <a href={data.link} target="_blank" rel="noreferrer" className="dp-btn-primary">
                  <Globe size={14} /> Live Preview
                </a>
                <a href={data.codeLink} target="_blank" rel="noreferrer" className="dp-btn-ghost">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-10 sm:mb-12">
            <StatPill label="Tech Stack" value={data.techStack.length} delay={0.2} />
            <StatPill label="Features" value={data.features.length} delay={0.25} />
          ...
          <Reveal delay={0.15}>
            <div className="dp-img-wrap mb-12 sm:mb-14">
              ...
              <div className="flex items-center gap-1.5 px-4 py-2.5 bg-white/5 border-b border-white/10">
                ...
                <span className="ml-3 text-[10px] sm:text-xs px-3 py-0.5 rounded-full bg-white/5 text-slate-500 font-mono truncate"
              ...
              <div className="dp-card p-6 sm:p-8 h-full">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <h2 className="font-display font-bold text-slate-100 text-lg sm:text-xl tracking-tight">Key Features</h2>
                  </div>
                </div>
                <ul className="space-y-0.5">
                  {data.features.map((f, i) => <FeatureItem key={i} feature={f} index={i} />)}
                </ul>
              </div>
            </Reveal>
              ...
              <div className="dp-card p-6 sm:p-8 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <h2 className="font-display font-bold text-slate-100 text-lg sm:text-xl tracking-tight">Tech Stack</h2>
                  </div>
                </div>
                <div className="flex flex-wrap gap-2">
                  {data.techStack.map((tech, i) => <TechBadge key={i} tech={tech} index={i} />)}
                </div>
                <div className="mt-auto pt-6">
                  <div className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                    <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                      Each technology was chosen for performance, developer experience, and real-world reliability.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Reveal delay={0.1}>
            <div className="dp-card p-6 sm:p-10 mb-10 sm:mb-14">
              ...
              <p className="text-slate-300 leading-relaxed text-sm sm:text-base mb-5">{data.overview}</p>

              {data.description && (
                <>
                  <div className="dp-divider my-5" />
                  <h3 className="dp-lbl mb-3">In Depth</h3>
                  <p className="text-slate-300 leading-relaxed text-sm sm:text-base">{data.description}</p>
                </>
              )}

              {/* CTA */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-8 pt-6 border-t border-white/10">
                <span className="text-slate-500 text-xs sm:text-sm font-mono">Ready to explore?</span>
                <div className="flex flex-wrap gap-3">
                  <a href={data.link} target="_blank" rel="noreferrer" className="dp-btn-primary">
